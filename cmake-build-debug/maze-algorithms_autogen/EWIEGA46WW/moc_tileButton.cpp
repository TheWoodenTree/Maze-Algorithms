...
Q_CONSTINIT static const qt_meta_stringdata_CLASSTileButtonENDCLASS_t qt_meta_stringdata_CLASSTileButtonENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(11, 4),  // "drag"
        QT_MOC_LITERAL(16, 0),  // ""
        QT_MOC_LITERAL(17, 3),  // "row"
        QT_MOC_LITERAL(21, 3),  // "col"
        QT_MOC_LITERAL(25, 12)   // "rightClicked"
    },
    "TileButton",
    "drag",
    "",
...
void TileButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->drag((*reinterpret_cast< std::add_pointer_t<int>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<int>>(_a[2]))); break;
        ...
        {
            using _t = void (TileButton::*)(int , int );
            if (_t _q_method = &TileButton::drag; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void TileButton::drag(int _t1, int _t2)
{
